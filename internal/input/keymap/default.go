...
func DefaultNormalKeymap() *Keymap {
	return &Keymap{
		...
		Bindings: []Binding{
			...
			// Scrolling
			{Keys: "C-d", Action: "scroll.halfPageDown", Description: "Scroll half page down", Category: "Scrolling"},
			{Keys: "C-u", Action: "scroll.halfPageUp", Description: "Scroll half page up", Category: "Scrolling"},
			{Keys: "C-f", Action: "scroll.pageDown", Description: "Scroll page down", Category: "Scrolling"},
			{Keys: "C-b", Action: "scroll.pageUp", Description: "Scroll page up", Category: "Scrolling"},
			{Keys: "C-e", Action: "scroll.lineDown", Description: "Scroll line down", Category: "Scrolling"},
			{Keys: "C-y", Action: "scroll.lineUp", Description: "Scroll line up", Category: "Scrolling"},
...
func DefaultGlobalKeymap() *Keymap {
	return &Keymap{
		...
		Bindings: []Binding{
			...
			{Keys: "<C-w>o", Action: "window.closeOthers", Description: "Close other windows", Category: "Window"},
			{Keys: "<C-w>=", Action: "window.equalSize", Description: "Equal window sizes", Category: "Window"},
			{Keys: "<C-w>_", Action: "window.maximizeHeight", Description: "Maximize height", Category: "Window"},
